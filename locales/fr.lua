Locales['fr'] = {
  ['cloakroom'] = 'Vestiaire',
  ['wash_clothes_civil'] = 'Tenue Civil',
  ['wash_clothes_wash'] = 'Tenue Blanchisseur',
  ...
  ['only_wash'] = 'vous ne pouvez ranger que votre véhicule de fonction',
  ['must_in_wash'] = 'vous devez être dans votre véhicule de fonction pour commencer la mission',
